...
/// Unified ODT viewer that replaces ODTDetailViewer and ODTViewerContent
struct ODTViewerView: View {
    let odtData: Data
    let fileName: String
